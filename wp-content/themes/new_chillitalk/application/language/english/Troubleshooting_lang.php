...
<h3>Why am I asked for a PIN code when I make a Local Numbers call?</h3>
<p>There are two reasons why this might happen:<br/>  <br/>
•	You have called from a number that's not registered with us.<br/>  <br/>
•	Your Caller ID is hidden. This means we can't identify your phone and will ask for your account number and PIN code. Your Caller ID is the number that displays when you call someone. If you enable your caller ID we should be able to identify your phone and we won't need to ask for your PIN code. 
</p>
<h3>Calls are connecting to the wrong numbers - why? </h3>
<p>This can happen if you're calling from a phone number that is on a different account. You could be connected to the wrong person because the Local Numbers you call aren't unique to you or your account. Therefore other users will be calling the same Local Numbers. The part that's linked to your account is where these numbers connect to. That means if you call from someone else's Chillitalk-registered phone you could be connected to their contact.</p>");
