 ...
 <![endif]-->
 <title>Cheap international call rates from Chillitalk </title>
...
(+381)</option>
    ...
    <form method="POST" id="panel1">
      ...
      <div class="ratesflag leftcom">
          ...
          <div class="countrate leftcom">
           ...
           <div class="countrate leftcom">
              <span>4<?php echo $this->config->item('rates_web'); ?></span>
          </div>
      </div>
    ...
    <form method="POST" id="panel2" >
      ...
      <div class="rates leftcom">
          <div class="rbboxl" id="landline" style="font-size:32px;"></div>
          <div class="rbboxl" id="mobile" style="font-size:32px;"></div>
          <div class="rbboxl" id="sms" style="font-size:32px;"></div>
      </div>
...
<!--  <?php echo lang('rates.tryusout31');?>-->
     <p><b style="font-size: 22px;">So cheap! So easy!</b><br /><br />	<b>FREE to try</b>   – We’ll give you your first call for FREE (or use your FREE credit for SMS). 
<br />
<br />
<b>FREE calls</b> to other Chillitalk users worldwide.
<br /><br />	<b>Dial direct</b> from your mobile/landline. Use our Local Numbers and call your contacts. 
<br />
<br />



<b style="font-size: 22px;">Super service</b></p>
<br /><br /><p>	<b>Use any device</b> – Any landline/mobile using Local Numbers or download the 
<a href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/application/">
Chillitalk App for iPhone, Android, iPhone or PC</a>.
<br /><br/>	<b>Flexibility</b> – Connect using your local network’s free minutes or a WiFi/3G connection – 
whichever is convenient and cost-effective for you. 
<br /><br/>
<b>Superb voice quality</b> – Crystal clear calls bring you closer to friends and family. 
<br /><br/>
	<b>Call from anywhere</b> – The Chillitalk App works anywhere in the world on WiFi, 
while you can call from your <a href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/chillitalk_access_number/">Local Numbers/Access Numbers</a> in more than 
<a href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/chillitalk_countries">50 countries</a>.
<br /><br/>
	<b>No hidden charges</b> – Pay super-cheap Chillitalk rates ONLY!
<br /><br/>
</p>
